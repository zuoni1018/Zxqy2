...
public class RvResumeAdapter4 extends RecyclerView.Adapter<RvResumeAdapter4.MyViewHolder> {
    ...
    public RvResumeAdapter4(Context mContext, List<ResumeManager> mList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = mInflater.inflate(R.layout.rv_resume_item4, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.jobName.setText(mList.get(position).getHopepostion());//期望职位
        ...
        holder.layoutChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RvResumeAdapter4.this.notifyDataSetChanged();
            }
        });
...
//        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View itemView) {
            ...
            SwipeMenuView=itemView.findViewById(R.id.SwipeMenuView);
