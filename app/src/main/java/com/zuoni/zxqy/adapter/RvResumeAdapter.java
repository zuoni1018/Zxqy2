...
public class RvResumeAdapter extends RecyclerView.Adapter<RvResumeAdapter.MyViewHolder> {
    ...
    public RvResumeAdapter(Context mContext, List<ResumeManager> mList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = mInflater.inflate(R.layout.rv_resume_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.layoutChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RvResumeAdapter.this.notifyDataSetChanged();
            }
        });
